...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//The declaration of the variable internal is declarated inside of the myFunction code block.
//Anything inside of the scope belonging to myFunction can access the internal variable. 
//Since the nested function is inside of myFunction, the variable internal can be accessed. 
...
const zooAnimals = [
  ...
  */
  ...
  {
    let arr = zooAnimals.map(function(item)
    {
  ...
  */
  ...
  {
    let arr = zooAnimals.filter(function(item)
    {
  ...
  */
  ...
  {
    let val = zooAnimals.reduce(function(accumulator, item)
    {
